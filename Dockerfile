...
RUN parallel_studio_xe_2017_update4_composer_edition/install.sh -s silent.cfg
...
RUN echo "system.has_qt5=true" >> /opt/buildagent/conf/buildAgent.dist.properties && \
    ...
    echo "system.agent_name=fedora-icc2017" >> /opt/buildagent/conf/buildAgent.dist.properties  && \
    echo "system.agent_repo=https://github.com/jeandet/teamcity-docker-agent-fedora-icc2017" >> /opt/buildagent/conf/buildAgent.dist.properties
